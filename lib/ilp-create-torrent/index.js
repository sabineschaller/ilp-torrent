/* Tweaked version of https://github.com/webtorrent/create-torrent */
...
const getFiles = require('create-torrent/get-files') // browser exclude
...
function onFiles (files, opts, cb) {
  ...
  if (opts.paymentRequired === true) torrent.license = createLicense(opts.license)
